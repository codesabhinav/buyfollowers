                        ...
                        >
                            <div className="flex flex-wrap items-center gap-6">
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <span
                                        className={`px-4 py-0 rounded-lg text-white text-sm font-semibold cursor-pointer ${getStatusColor(
                                ...
                                <div className="w-full flex flex-col lg:flex-row items-center gap-4">
                                    <div className="w-[123px]">
                                        <img
                                            ...
                                            className="w-[93px] h-[93px] object-center rounded-full border-2 border-dashed border-pink-500 p-2 bg-pink-300/20"
                                        />
                                    </div>

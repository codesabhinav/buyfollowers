                    ...
                    <div className="flex flex-col gap-2 p-1 lg:p-4 w-full">
                        <div className="flex flex-col w-full border border-[#FFEEF9] rounded-xl">
                            <div className="flex items-center gap-2 bg-white">
                                <motion.div
                                    className={`${activeTab === "highQuality"
                                        ? "bg-[#D52E9C]"
                                        : "bg-transparent"
                                ...
                                >
                                    <span
                                        className={`text-lg ${activeTab === "highQuality"
                                            ? "text-white"
                                            : "text-[#D52E9C]"
                                            } font-semibold`}
                                    >
                                    ...
                                    <span
                                        className={`text-sm ${activeTab === "highQuality"
                                            ? "text-white"
                                            : "text-[#D52E9C]"
                                            } font-semibold`}
                                    >
                                ...
                                >
                                    <span
                                        className={`text-lg ${activeTab === "active"
                                            ? "text-white"
                                            : "text-[#D52E9C]"
                                            } font-semibold`}
                                    >
                                    ...
                                    <span
                                        className={`text-sm ${activeTab === "active"
                                            ? "text-white"
                                            : "text-[#D52E9C]"
                                            } font-semibold`}
                                    >

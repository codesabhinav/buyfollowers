...
const FirstSection = () => {
    return (
        <>
            <div className="relative bg-transparent w-full mt-8 lg:mt-28 flex flex-col lg:flex-row justify-between items-center gap-48">
                {/* Left Section */}
                ...
                <div className="flex flex-col justify-center items-center gap-20 w-full relative mt-12 lg:mt-0">
                    <ServicesCarousel />
